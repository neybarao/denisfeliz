...
if ( ! isset( $content_width ) ) $content_width = 1120;
 ...
 function onetone_custom_scripts(){
	...
	wp_enqueue_style( 'onetone-main', get_stylesheet_uri(), array(), '1.1.6' );
   ...
   $onetone_custom_css = "";
    ...
    if ( 'blank' != get_header_textcolor() && '' != get_header_textcolor() ){
     $header_background  .=  ' background-color:#' . get_header_textcolor() . ';';
	 $onetone_custom_css .=  '.home-header{'.$header_background.'}';
		}
	...
	if($top_menu_font_color !="" && $top_menu_font_color!=null){
		$onetone_custom_css  .=  '#menu-main > li > a span{color:'.$top_menu_font_color.'}';
		}
